...
public class Biblioteca {
	...
	public void menu() {
		...
		if(escolha==1) {
            System.out.println("Lauren Weisberger trabalhou como assistente da todo poderosa amada e odiada editora da revista Vogue,"
		...
		if(escolha==2) {
            System.out.println("Bernadette Fox é notável. Aos olhos de seu marido,"
		...
		if(escolha==3) {
            System.out.println("no século XIV período renascentista e dividido em três partes: o Inferno," 
		...
		if(escolha==4) {
            System.out.println("Diz a crença popular que a vingança é um prato que se come frio."
		...
		if(escolha==5) {
            System.out.println("A obra é um mergulho no divertido universo que Bolaños desenvolveu para o programa mexicano," 
		...
		if(escolha==6) {
            System.out.println("Elas vão ajudar a solidificar os conhecimentos," 
